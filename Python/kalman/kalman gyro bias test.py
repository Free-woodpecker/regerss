# -*- coding: utf-8 -*-
"""
Created on Thu Sep 17 13:30:18 2020
...
def KalmanFilter(z,  n_iter = 20):  
    ...
    R = 2.56 # estimate of measurement variance, change to see effect  
...
if __name__ == '__main__':
    ...
    with open('223.csv', 'r') as f:
        ...
        for row in reader:
            raw_data.append(float(row[3]))

    
    print(numpy.var(raw_data))       # 打印方差
